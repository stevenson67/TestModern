...
const heroLeft = document.querySelector(".hero__letters-left"),
  ...
  hero = document.querySelector(".hero__hidden");
hero.addEventListener('mouseover', () => {
  heroLeft.style.transform = "translateX(-500px)";
  heroRight.style.transform = "translateX(250px)";
  heroDescr.style.transform = "translateX(-65px)";
  heroVideo.style.opacity = 1;
  heroVideo.style.scale = 1.1;
});
hero.addEventListener('mouseout', () => {
  heroLeft.style.transform = "translateX(0px)";
  heroRight.style.transform = "translateX(0px)";
  heroDescr.style.transform = "translateX(0px)";
  heroVideo.style.opacity = 0;
  heroVideo.style.scale = 1;
});
const mediaQueryMax = window.matchMedia('(max-width: 1440px)')
if (mediaQueryMax.matches) {
  hero.addEventListener('mouseover', () => {
    heroLeft.style.transform = "translateX(-400px)";
    heroRight.style.transform = "translateX(250px)";
    heroDescr.style.transform = "translateX(47px)";
    heroVideo.style.opacity = 1;
    heroVideo.style.scale = 1.1;
  });
} 
...
if (mediaQueryMob.matches) {
  const heroLeftMob = document.querySelector(".hero__letters-left"),
  heroRightMob = document.querySelector(".hero__letters-right"),
  heroDescrMob = document.querySelector(".hero__descr"),
  heroVideoMob = document.querySelector(".hero__video"),
  heroMob = document.querySelector(".hero__hidden");
hero.addEventListener('mouseover', () => {
  heroLeftMob.style.transform = "translateX(-200px)";
  heroRightMob.style.transform = "translateX(120px)";
  heroDescrMob.style.transform = "translateX(105px)";
  heroVideoMob.style.opacity = 1;
  heroVideoMob.style.scale = 1.1;
});
hero.addEventListener('mouseout', () => {
  heroLeftMob.style.transform = "translateX(0px)";
  heroRightMob.style.transform = "translateX(0px)";
  heroDescrMob.style.transform = "translateX(0px)";
  heroVideoMob.style.opacity = 0;
  heroVideoMob.style.scale = 1;
});
}
const mediaQueryMobL = window.matchMedia('(max-width: 425px)')
if (mediaQueryMobL.matches) {
  const heroLeftMobL = document.querySelector(".hero__letters-left"),
  heroRightMobL = document.querySelector(".hero__letters-right"),
  heroDescrMobL = document.querySelector(".hero__descr"),
  heroVideoMobL = document.querySelector(".hero__video"),
  heroMob = document.querySelector(".hero__hidden");
hero.addEventListener('mouseover', () => {
  heroLeftMobL.style.transform = "translateX(-110px)";
  heroRightMobL.style.transform = "translateX(80px)";
  heroDescrMobL.style.transform = "translateX(20px)";
  heroVideoMobL.style.opacity = 1;
  heroVideoMobL.style.scale = 1.1;
});
hero.addEventListener('mouseout', () => {
  heroLeftMobL.style.transform = "translateX(0px)";
  heroRightMobL.style.transform = "translateX(0px)";
  heroDescrMobL.style.transform = "translateX(0px)";
  heroVideoMobL.style.opacity = 0;
  heroVideoMobL.style.scale = 1;
});
}
...
const mediaDescrMobL = window.matchMedia('(max-width: 425px)')
if (mediaDescrMobL.matches) {
  const textTitle = document.querySelector(".description__title");
  const textLineHead = window.getComputedStyle(textTitle).lineHeight;
  const textLineHeadEnd = `${parseInt(window.getComputedStyle(textTitle).lineHeight) - 20}px`;
  const textLineHeightStart = {
    lineHeight: textLineHead
  };
  const showLineHeight = (textTitle, textLineHeightStart) => {
...
const mediaCircleMobL = window.matchMedia('(max-width: 425px)')
if (mediaCircleMobL.matches) {
  gsap.to(".circles__circle", {
    width: 3000,
    height: 1500,
    scrollTrigger: {
